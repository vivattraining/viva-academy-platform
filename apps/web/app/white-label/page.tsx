...
export default function WhiteLabelPage() {
  return (
    <SiteShell
      ...
      description="VIVA is the first tenant, but the platform should be designed so future institutes can configure brand, domain, faculty, classroom defaults, and certification identity without product rewrites."
    ...
    >
      <section className="grid grid-2">
        <article className="card" style={{ background: ACADEMY_THEME.primary, color: "white" }}>
          ...
          <div style={{ marginTop: 14, fontSize: 28, fontWeight: 900, letterSpacing: "-0.05em" }}>academy.vivatraininginstitute.com</div>
